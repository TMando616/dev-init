...
## 2. Admin UI (Frontend)
- [x] 2.1 カテゴリ管理画面 (`/admin/categories`) の構築
- [x] 2.2 レッスン作成・編集画面へのカテゴリ複数選択機能の追加
- [x] 2.3 サイドバーへの「カテゴリ管理」リンクの追加

## 3. User UI & Dashboard (Frontend)
- [x] 3.1 トップページ (`/`) のダッシュボード化 (進捗グラフ・最近のレッスン)
- [x] 3.2 カテゴリ別レッスン一覧表示機能の実装
- [x] 3.3 演習画面への「完了」ボタンの追加とAPI連携
